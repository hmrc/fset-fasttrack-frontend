...
object ProgressExamples {
  ...
  val SchemePreferencesProgress = PersonalDetailsProgress.copy(frameworksLocation = true)
  ...
  val FullProgress = Progress(true, true, true, true, true, true, true, true, true, false,
