...
object Roles {
  ...
  val userJourneySequence: List[(CsrAuthorization, Call)] = List(
    ...
    DiversityQuestionnaireRole -> routes.QuestionnaireController.start,
    EducationQuestionnaireRole -> routes.QuestionnaireController.start,
    ParentalOccupationQuestionnaireRole -> routes.QuestionnaireController.start,
